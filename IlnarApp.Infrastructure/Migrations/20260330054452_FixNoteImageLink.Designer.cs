...
namespace IlnarApp.Infrastructure.Migrations
{
    ...
    [Migration("20260330054452_FixNoteImageLink")]
    partial class FixNoteImageLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IlnarApp.Domain.Note.NoteImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NoteNoteImage", b =>
                {
                    b.Property<Guid>("NoteImagesId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("NotesId")
                        .HasColumnType("uuid");

                    b.HasKey("NoteImagesId", "NotesId");

                    b.HasIndex("NotesId");

                    b.ToTable("NoteNoteImages", (string)null);
                });
            ...
            modelBuilder.Entity("NoteNoteImage", b =>
                {
                    b.HasOne("IlnarApp.Domain.Note.NoteImage", null)
                        .WithMany()
                        .HasForeignKey("NoteImagesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
